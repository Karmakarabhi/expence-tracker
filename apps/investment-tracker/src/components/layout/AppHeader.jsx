  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b bg-background/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      ...
      <div className="hidden md:flex relative max-w-md flex-1">
        ...
        <Input
          placeholder="Search mutual funds, stocks, ETFs, schemes…"
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <div className="h-8 w-8 rounded-full bg-gradient-to-br from-violet-600 to-indigo-600 text-white flex items-center justify-center text-xs font-semibold">
